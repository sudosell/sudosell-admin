      ...
      return `
        <tr>
          <td style="padding:12px 16px;border-bottom:1px solid rgba(255,255,255,0.04);">
            ...
            <p style="margin:0;font-size:13px;color:#d0d0e0;line-height:1.5;white-space:pre-wrap;">${escapeHtml(m.content)}</p>
          </td>
        </tr>`;
    })
    .join("");
        ...
        <div style="max-width:560px;margin:0 auto;background:#0d0d12;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden">
          ...
          <div style="padding:32px">
            ...
            <p style="color:#9898ac;font-size:14px;line-height:1.6;margin:0 0 24px">
              Hi ${escapeHtml(name)}, your support ticket <strong style="color:#fff">"${escapeHtml(subject)}"</strong> has been closed. Below is the full conversation transcript for your records.
            </p>
      ...
      <div style="background:#08080d;padding:40px 20px;font-family:system-ui,sans-serif">
        <div style="max-width:480px;margin:0 auto;background:#0d0d12;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden">
          ...
          <div style="padding:32px">
            ...
            <p style="color:#9898ac;font-size:14px;line-height:1.6;margin:0 0 24px">
              Hi ${escapeHtml(name)}, <strong style="color:#fff">${escapeHtml(productName)}</strong> has been updated to <strong style="color:#b249f8">v${escapeHtml(version)}</strong>.
            </p>
            ${notesHtml}
    ...
    html: `
      <div style="background:#08080d;padding:40px 20px;font-family:system-ui,sans-serif">
        <div style="max-width:480px;margin:0 auto;background:#0d0d12;border:1px solid rgba(255,255,255,0.06);border-radius:16px;padding:32px">
          <h2 style="color:#fff;font-size:18px;margin:0 0 8px">Hi ${escapeHtml(name)},</h2>
          <p style="color:#9898ac;font-size:14px;line-height:1.6;margin:0 0 20px">
            An admin has replied to your support ticket <strong style="color:#fff">"${escapeHtml(subject)}"</strong>.
          </p>
